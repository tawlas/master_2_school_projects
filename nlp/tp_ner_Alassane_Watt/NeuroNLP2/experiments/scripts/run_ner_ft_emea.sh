#!/usr/bin/env bash
CUDA_VISIBLE_DEVICES=0 OMP_NUM_THREADS=3 python ner.py --config configs/ner/quaero-100-demi.json --num_epochs 15 --batch_size 16 \
 ...
 --embedding sskip --embedding_dict "models/we_models/ft_sg_m.kv.gz" --model_path "models/ner/ner_ft_sg_emea" \
